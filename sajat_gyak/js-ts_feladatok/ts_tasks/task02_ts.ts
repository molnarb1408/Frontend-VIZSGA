...
function isWeekend(date: Date): boolean {
    const day = parseInt((prompt("Írjon be egy számot ami reprezentálja a hétnapjait (1-hétfő, 2-kedd, 3-szerda, 4-csütörtök, 5-péntek, 6-szombat, 7-vasárnap") as string), 10);
    if (day < 1 || day > 7) {
