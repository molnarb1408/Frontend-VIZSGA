...
// !5 = 1*2*3*4*5
function factorialForCalculate(n) {
    let sum = 1;
    for (let i = 1; i <= n; i++) {
...
function factorialRecursiveCalculate(n) {
    if (n == 0)
        return 1; // itt áll meg a rekurzív algoritmus
    else
        return factorialRecursiveCalculate(n - 1) * n;
}
